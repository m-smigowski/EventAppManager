    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h3">Dodawanie klienta</h1>
            ...
            <section class="client-list-add">
                <form class=" w-75 box" action="addClient" method="POST">
                    ...
                    <div class="form-outline mb-2">
                        ...
                        <input name="phone" type="tel" pattern="(?:(?:(?:\+|00)?48)|(?:\(\+?48\)))?(?:1[2-8]|2[2-69]|3[2-49]|4[1-8]|5[0-9]|6[0-35-9]|[7-8][1-9]|9[145])\d{7}" class="form-control" required/>
                    </div>
                    ...
                    <div class="d-flex mt-2">
                        <button type="submit" class="btn btn-success me-2" name="addClient">
                            Dodaj
                        </button>
