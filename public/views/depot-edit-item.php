    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h3">Edycja przedmiotu</h1>
            ...
            <section class="item-edit">
                <form action="editDepotItem" method="POST" ENCTYPE="multipart/form-data">
                    ...
                    <button type="submit" class="btn btn-success" name="Update">Zaktualizuj</button>
                    <button type="submit" class="btn btn-danger" name="Drop"> Usuń</button>
